...
class Mirasvit_Seo_Block_Html_Head extends Mage_Page_Block_Html_Head
{
    ...
    public function setupCanonicalUrl()
    {
        ...
        if (false && $product) { //Ð²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ Ð² Ð¿ÐµÑÑÐ¿ÐµÐºÑÐ¸Ð²Ðµ Ð²ÑÐ²ÐµÑÑÐ¸ ÑÑÐ¾ Ð² ÐºÐ¾Ð½ÑÐ¸Ð³ÑÑÐ°ÑÐ¸Ñ. Ñ.Ðº. ÑÑÐ¾ Ð½ÑÐ¶Ð½Ð¾ ÑÐ¾Ð»ÑÐºÐ¾ Ð² Ð½ÐµÐºÐ¾ÑÐ¾ÑÑÑ ÑÐ»ÑÑÐ°ÑÑ.
