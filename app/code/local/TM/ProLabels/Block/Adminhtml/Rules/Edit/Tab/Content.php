...
class TM_ProLabels_Block_Adminhtml_Rules_Edit_Tab_Content extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('product_image_text', 'text', array(
            ...
            'after_element_html' => '<small>#discount_percent# or #discount_amount# or #special_price# or #special_date# or #final_price# or #price# or #product_name# or #product_sku# or #stock_item#</small>',
        ));
