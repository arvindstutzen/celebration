...
class DownloadableProcessor extends Magmi_ItemProcessor
{
    ...
    {
        $dl = $this->tablename('mg_downloadable_link');
        $sql = "select * from mg_downloadable_link where product_id = ?";
    ...
    {
        $dl = $this->tablename('mg_downloadable_link');
        $dlt = $this->tablename('mg_downloadable_link_title');
    ...
    {
        $dlp = $this->tablename('mg_downloadable_link_price');
